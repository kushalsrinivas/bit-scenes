  ...
  return (
    <figure
      className={cn(
        ...
        // light styles
        "border-gray-950/[.1] bg-yellow-400/40 hover:bg-gray-950/[.05]",
        // dark styles
...
export function MarqueeDemo() {
  return (
    <div className="absolute inset-0 z-0">
      <div className="bg-background relative flex h-auto w-full flex-col items-center justify-center overflow-hidden rounded-lg border md:shadow-xl">
